    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Category>().HasData(
                ...
                new Category { Id = 15, Name = "Income", Description = "Payroll, salary, wages, direct deposits, tax refunds, government benefits, and other income", Keywords = "payroll,pay,salary,wages,direct deposit,paycheque,paycheck,deposit,employer,payroll deposit,income,pension,cpp,oas,ei,cra refund,tax refund,bonus,commission,interest,dividend", CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc)}
            );
